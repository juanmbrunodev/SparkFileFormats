...
public class FilesFormats {
    ...
    private static final String XML_PATH_RESOURCES = "src/main/resources/spark-data/widgets.xml";
    private static final String TXT_PATH_RESOURCES = "src/main/resources/spark-data/protagoras.txt";
    private static final String PARQUET_PATH_RESOURCES = "src/main/resources/spark-data/userdata1.parquet";
...
//                .option("multiline", true)
        ...
        /** READ PARQUET FILE **/
        Dataset<Row> parquetDf = session.read().format("parquet")
